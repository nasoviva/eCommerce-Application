...
Executes a multi-step production build: 1. Formats code with Prettier 2. Fixes TypeScript issues with ESLint 3. Fixes style issues with Stylelint 4. Checks code formatting 5. Bundles the application using Webpack in production mode
